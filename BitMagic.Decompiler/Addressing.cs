...
public static class OpCodes
{
    public static (string OpCode, Addressing.AddressMode AddressMode) GetOpcode(int code) => code switch
    {
        ...
        0x03 => ("NOP I", AddressMode.Implied),
        0x0B => ("NOP I", AddressMode.Implied),
        0x13 => ("NOP I", AddressMode.Implied),
        0x1B => ("NOP I", AddressMode.Implied),
        0x23 => ("NOP I", AddressMode.Implied),
        0x2B => ("NOP I", AddressMode.Implied),
        0x33 => ("NOP I", AddressMode.Implied),
        0x3B => ("NOP I", AddressMode.Implied),
        0x43 => ("NOP I", AddressMode.Implied),
        0x4B => ("NOP I", AddressMode.Implied),
        0x53 => ("NOP I", AddressMode.Implied),
        0x5B => ("NOP I", AddressMode.Implied),
        0x5C => ("NOP", AddressMode.Absolute),
        0x63 => ("NOP I", AddressMode.Implied),
        0x6B => ("NOP I", AddressMode.Implied),
        0x73 => ("NOP I", AddressMode.Implied),
        0x7B => ("NOP I", AddressMode.Implied),
        0x83 => ("NOP I", AddressMode.Implied),
        0x8B => ("NOP I", AddressMode.Implied),
        0x93 => ("NOP I", AddressMode.Implied),
        0x9B => ("NOP I", AddressMode.Implied),
        0xA3 => ("NOP I", AddressMode.Implied),
        0xAB => ("NOP I", AddressMode.Implied),
        0xB3 => ("NOP I", AddressMode.Implied),
        0xBB => ("NOP I", AddressMode.Implied),
        0xC3 => ("NOP I", AddressMode.Implied),
        0xD3 => ("NOP I", AddressMode.Implied),
        0xE3 => ("NOP I", AddressMode.Implied),
        0xEB => ("NOP I", AddressMode.Implied),
        0xF3 => ("NOP I", AddressMode.Implied),
        0xFB => ("NOP I", AddressMode.Implied),

        0x02 => ("NOP", AddressMode.Immediate),
        0x22 => ("NOP", AddressMode.Immediate),
        0x42 => ("NOP", AddressMode.Immediate),
        0x44 => ("NOP", AddressMode.ZeroPage),
        0x54 => ("NOP", AddressMode.XIndexedZeroPage),
        0x62 => ("NOP", AddressMode.Immediate),
        0x82 => ("NOP", AddressMode.Immediate),
        0xC2 => ("NOP", AddressMode.Immediate),
        0xD4 => ("NOP", AddressMode.XIndexedZeroPage),
        0xE2 => ("NOP", AddressMode.Immediate),
        0xF4 => ("NOP", AddressMode.XIndexedZeroPage),
